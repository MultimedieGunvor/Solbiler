...
STAMOPLYSNINGER.insertAdjacentHTML("afterbegin", `
    ...
    <h3>Adresse: ${sessionStorage.getItem("vejnavn")}&nbsp;${sessionStorage.getItem("husnr")}</h3>
...
// Musik
"use strict";
const musikstykke = new Audio("/musik/bensound-memories.mp3");

document.getElementById("spil").addEventListener("click", function () {
    // musikstykke.currentTime = 0; // Får musikstykket til at starte forfra
    musikstykke.play();
})
